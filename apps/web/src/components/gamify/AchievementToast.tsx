    ...
    <AnimatePresence>
      {unlocked && (
        <motion.div
          ...
          className="fixed bottom-24 left-1/2 z-50 -translate-x-1/2 rounded-full bg-gradient-to-br from-primary via-secondary to-tertiary px-5 py-2.5 text-sm font-semibold text-on-primary shadow-glow-lg"
        >
